$(function(){
  ...
  function appendItem(data){
    ...
    if(data.user_sign_in && data.user_sign_in.id == data.user_id){
      var current_user = `
        <ul class="item-nav">
          <ul class="item-nav__show-page">
            <li class="item-nav__show-page__comment">
              <a class="link-btn" data-method="get" href="/items/${data.id}/">comment</a>
            </li>
            <li class="item-nav__show-page__user">
              <a class="link-btn" href="/items/${data.id}/">${data.name}</a>
            </li>
          </ul>
          <ul class="item-nav__current-user">
            <li class="item-nav__current-user__edit">
              <a class="link-btn" data-method="get" href="/items/${data.id}/">edit</a>
            </li>
            <li class="item-nav__current-user__delete">
              <a class="link-btn" rel="nofollow" data-method="delete" href="/items/${data.id}/">delete</a>
            </li>
          </ul>
        </ul>
      `;
    ...
    var html = `
      <div class="item-row">
        <div class="contents-row" style="background-image: url(${data.image});"></div>
        ${current_user}
      </div>
    `;
